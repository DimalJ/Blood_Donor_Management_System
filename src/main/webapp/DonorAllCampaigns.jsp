...
<div style="width: 900px;" class="mx-auto">
	<nav class="nav nav-pills nav-fill">
	  ...
	  <a class="nav-item nav-link active" href="<%= request.getServletContext().getContextPath()%>/DonorAllCampaignsServlet">Campaign List</a>
	</nav>
</div>
<div class="container">
        <h1 class="mt-5 mb-3">Blood Donation Campaigns </h1>
